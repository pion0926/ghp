...
class __TwigTemplate_0577dbc06df93b20d25598666fc5db57 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "/cd0926/www/dbeditor/templates/database/export/index.twig");
    }
}
