<section id="container" class="introduce group_num_206">
    <div class="contents page_206">
        <div class="contenstView">
            <div class="section">
                ...
                <div class="halfCont">
                    ...
                    <p class="imgBox"><img src="/web_basic/img/introduce/top02.jpg" alt="미션"></p>
                </div>
            </div>
            <div class="section topLine">
                <div class="sectionTop">
                    <h3 class="sectionTitle">핵심가치</h3>
                    <p class="sectionTitleSub c_00afb1">Core Value</p>
                </div>
                <ul class="iconList bg_f2fafb" style="display: flex; justify-content: space-between;">
                    ...
                    <li>
                        ...
                        <dl>
                            <dt>혁신과 협력</dt>
                            <dd>다양한 파트너 및 전문가와 협력하여,<br>혁신적인 보건의료 솔루션을 모색하고<br> 제공합니다.</dd>
                        </dl>
                    </li>
                    <li>
            ...
            <div class="section topLine">
                <div class="sectionTop">
                    <h3 class="sectionTitle">CI 소개</h3>
                    <p class="sectionTitleSub">국제보건 NGO 글로벌헬스파트너스의 공식 CI입니다</p>
                </div>
                <ul class="ciList">
                    <li>
                        국문
                ...
                <div class="ciCont">
                    <dl>
                        <dt class="shotLine">로고의 의미</dt>
                        <dd>글로벌헬스파트너스(GHP)의 로고는 전 세계적인 건강 증진을 위한 협력과 나눔의 가치를 상징합니다.
                            <br> <strong>*지구 모양</strong>: 글로벌 헬스 파트너스가 국내외 보건문제 해결을 위해 노력하며, 전 세계의 건강 형평성을 위해 활동한다는 의미를 담고 있습니다. 
                            <br> <strong>*녹색 심장과 의료 십자가</strong>: 건강과 생명을 보호하는 보건의료지원의 핵심 가치를 강조하며, 인도주의적 보건 활동을 통해 인류의 삶을 개선하는 목표를 나타냅니다. 
                            <br> <strong>*푸른 원형 띠</strong>: 다양한 파트너와의 협력을 통해 지속 가능한 보건의료 환경을 조성하고, 글로벌 네트워크를 구축하여 더 나은 건건강을 제공한다는 의미를 담고 있습니다. 
                        </dd>
                    </dl>
                    <dl class="mb_50">
                        <dt class="shotLine">색상 규정</dt>
                        <dd>글로벌헬스파트너스의 로고 색상은 생명, 건강, 신뢰, 협력의 가치를 반영합니다.
                            <br class="brNone"> 이 색상을 글로벌헬스파트너스가 추구하는 건강한 미래, 지속 가능한 보건 지원, 글로벌 협력의 가치를 시각적으로 표현하는 중요한 요소입니다.
                        </dd>
                    </dl>
                </div>
            </div>
